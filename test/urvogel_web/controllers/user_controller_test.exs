defmodule UrvogelWeb.UserControllerTest do
  use UrvogelWeb.ConnCase

  alias Urvogel.UrvogelWeb

  @create_attrs %{access_token: "some access_token", access_token_secret: "some access_token_secret", domain: "some domain", username: "some username"}
  ...
  def fixture(:user) do
    {:ok, user} = UrvogelWeb.create_user(@create_attrs)
    user
  end
