defmodule UrvogelWeb.InstanceControllerTest do
  use UrvogelWeb.ConnCase

  alias Urvogel.UrvogelWeb

  @create_attrs %{client_id: "some client_id", client_secret: "some client_secret", host: "some host"}
  ...
  def fixture(:instance) do
    {:ok, instance} = UrvogelWeb.create_instance(@create_attrs)
    instance
  end
